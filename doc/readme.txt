...
######################################################################
  This is the latest free FastCopy version, downloaded from:
  https://web.archive.org/web/20230326160040/https://raw.githubusercontent.com/FastCopyLab/FastCopyDist/main/FastCopy4.2.2_installer.exe

  German Translations provided by vitusb.
######################################################################
...
======================================================================
	...
	It can copy/delete unicode and over MAX_PATH(260byte) pathname
	files.
...
xxHash library Copyright (C) 2012-2021 Mr.Yann Collet,
All rights reserved. More details: doc/xxhash-LICENSE.txt
